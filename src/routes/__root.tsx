...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Elite Scholars — Premium Coaching Institute" },
      { property: "og:description", content: "Building future doctors and engineers. JEE, NEET, Class 11 & 12 — small batches, proven results." },
